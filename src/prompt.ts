...
const _closeHandlers = new WeakMap<Prompt, () => void>();
...
export function mountPrompt(prompt: Prompt, parent: HTMLElement, closeHandler: () => void): void {
