Original GoopBox contributions are made under the [Unlicense](UNLICENSE).

---

GoopBox contains source code based upon/from other third-party projects.
...
- [flpdiff](https://github.com/dawhubapp/flpdiff)
  - [Licensed MIT](LICENSE/MIT)
...
The Unlicense dedication applies only to contributions whose authors have the right to make that dedication. It does not alter the license or copyright of BeepBox-derived or third-party material.
